...
rust-crypto)
	...
	for target in ed25519_verify ecdh_peer mlkem768nistp256_peer dh_peer ecdsa_parse rsa_parse chachapoly_decrypt config_helpers packet_mac sshkey_metadata sshkey_lifecycle; do
