...
mod tests {
    ...
    use super::{
        rsa_bits, rsa_component_len, rsa_export_component, rsa_free, rsa_from_private,
        rsa_generate, rsa_parse_private_pem_with_passphrase, rsa_parse_public_blob,
        rsa_sign_prehashed, rsa_verify_prehashed, OSSH_RUST_RSA_COMPONENT_D,
        OSSH_RUST_RSA_COMPONENT_E, OSSH_RUST_RSA_COMPONENT_IQMP, OSSH_RUST_RSA_COMPONENT_N,
        OSSH_RUST_RSA_COMPONENT_P, OSSH_RUST_RSA_COMPONENT_Q, SSH_DIGEST_SHA1, SSH_DIGEST_SHA256,
        SSH_DIGEST_SHA512,
    };
    ...
    fn export_component(key: *const c_void, component: c_int) -> Vec<u8> {
        ...
        assert_eq!(
            0,
            rsa_export_component(key, component, out.as_mut_ptr(), out.len())
        );
        out
    }
    ...
    fn parses_rsa_public_fixture_blob() {
        let blob = [
            ,
        ];
        let mut consumed = 0usize;
